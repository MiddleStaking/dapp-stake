...
export const ActionRestake = (props: { amount: BigNumber }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <p>
          Our contract has accumulated{' '}
          {props.amount.dividedBy(10 ** 18).toFixed(2)} EGLD, ready for
          decentralized staking. Sign the transaction to restake these funds,
          support liquidity, and enhance the efficiency of MID.
        </p>

...
//         first_k_pool /
//         (BigInt(second_pool.second_token_amount) + in_amount - first_in_fees);
//       const first_out_amount =
//         BigInt(second_pool.first_token_amount) - first_x_amount;

//       const second_in_fees =
//         (first_out_amount * BigInt(first_pool.first_fee)) / BigInt(10000);
...
//       const first_x_amount =
//         second_k_pool /
//         (BigInt(first_pool.second_token_amount) + in_amount - first_in_fees);
//       const first_out_amount =
//         BigInt(first_pool.first_token_amount) - first_x_amount;

//       const second_in_fees =
//         (first_out_amount * BigInt(second_pool.first_fee)) / BigInt(10000);
...
//                         <div className='ValueDetailsInfo'>
//                           <FormatAmount
//                             value={second_pool.second_fee.toString()}
//                             decimals={Number(2)}
//                             egldLabel={' '}
//                             data-testid='balance'
//                             digits={2}

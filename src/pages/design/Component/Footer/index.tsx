  ...
  return width > 450 ? (
    ...
    <div style={FooterMobile}>
      ...
      >
        ...
        <p
          style={
            firstSegment === routeNames.stake ? gradientStyle : labelIconStyle
          }
        >
          Stacking
        </p>
      ...
      >
        ...
        <p
          style={
            firstSegment === routeNames.play ? gradientStyle : labelIconStyle
          }
        >
          Play
        </p>
      ...
      <div
        ...
        style={{
          ...iconStyle,
          ...(firstSegment === routeNames.design
            ? backGroundActive
            : backGround)
        }}
      >
        <UserSvg select={firstSegment === routeNames.design} />
        <p
          style={
            firstSegment === routeNames.design ? gradientStyle : labelIconStyle
          }
        >
          Account
        </p>
...
const StackingSvg: FC<SvgProps> = ({ select }) => {
  return (
    <svg
      width='24'
      height='24'
    ...
    >
      ...
      <path
        ...
        fill={select ? 'url(#myGradient)' : '#ffffff'}
      />
    </svg>
  );
};

const LayoutSvg: FC<SvgProps> = ({ select }) => {
  return (
    <svg
      width='25'
      height='24'
...
const PlayCircleSvg: FC<SvgProps> = ({ select }) => {
  return (
    <svg
      width='25'
      height='24'
...
const UserSvg: FC<SvgProps> = ({ select }) => {
  return (
    <svg
      width='25'
      height='24'
